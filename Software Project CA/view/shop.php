        ...
        <script>
            $(document).ready(function(){
                ...
                $('#carouselExampleIndicators, #carouselExampleIndicatorsOutOfStock').carousel({
                    interval: 5000, // Set auto-slide interval in milliseconds (5 seconds)
                    pause: 'hover' // Pause auto-slide on mouse hover
                });

                // Add smooth transitions to the carousel items
                ...
                // Add fade-in and fade-out animations on slide events
